    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Kategori & Jenis Kendaraan</h1>
                    <p class="text-sm text-slate-500 mt-1">Kelola data jenis kendaraan, volume campuran, serta skema harga member & non-member</p>
                </div>
                <div>
                    <button onclick="openAddModal()" class="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm rounded-lg shadow-sm transition">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex items-center space-x-1">
                            <button onclick="editVehicle('{{ $vehicle['id'] }}')" class="p-1.5 text-slate-600 hover:text-blue-600 hover:bg-slate-100 rounded-lg transition" title="Edit">
                                <i data-lucide="pencil" class="w-4 h-4"></i>
                            </button>
                            <button onclick="deleteVehicle('{{ $vehicle['id'] }}')" class="p-1.5 text-slate-600 hover:text-rose-600 hover:bg-rose-50 rounded-lg transition" title="Hapus">
